...
let $sc1 := for $a in $trace1/class union $trace1/method union $trace1/param-types union $trace1/return-type union $trace1/args
 return fn:data($a)
let $sc2 := for $b in $trace2/class union $trace2/method union $trace2/param-types union $trace2/return-type union $trace2/args
return fn:data($b)
