...
public class DeleteSuggestionsCombinedAlgorithmNew {
	private FileOutputStream fout;
	public static void main(String[] args) throws Exception {
		new DeleteSuggestionsCombinedAlgorithmNew().createDeleteSuggestionReport();
	}
	...
	public void createDeleteSuggestionReport() throws Exception {
		...
		File xqueryFile = new File("delete_suggestions_combined_algorithm_newer.xqy");
