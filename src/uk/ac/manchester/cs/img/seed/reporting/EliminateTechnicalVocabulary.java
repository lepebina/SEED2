...
public class EliminateTechnicalVocabulary {
	private FileOutputStream fout;
	public static void main(String[] args) throws Exception {
		new EliminateTechnicalVocabulary().createDeleteSuggestionsReport();
	}
	...
	public void createDeleteSuggestionsReport() throws Exception {
		...
		File xqueryFile = new File("eliminate_tech_vocabulary.xqy");
