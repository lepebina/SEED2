...
public class IdentifyDuplicationNoVariation {
	public static void main(String[] args) throws XQException, IOException {
        new IdentifyDuplicationNoVariation().createXqueryDuplicationReport();
    }
    ...
    public void createXqueryDuplicationReport() throws XQException, IOException {
        ...
        File xqueryFile = new File("compare_full_trace.xqy");
