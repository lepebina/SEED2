...
public class IdentifyDuplicationNoVariationCompareFourTraces {
	public static void main(String[] args) throws XQException, IOException {
        new IdentifyDuplicationNoVariationAPICalls().createXqueryDuplicationReport();
    }
    ...
    public void createXqueryDuplicationReport() throws XQException, IOException {
        ...
        File xqueryFile = new File("compare_four_traces.xqy");
