...
public class IdentifyDuplicationNoVariationAPIandInternalCalls {
	public static void main(String[] args) throws XQException, IOException {
        new IdentifyDuplicationNoVariationAPIandInternalCalls().createXqueryDuplicationReport();
    }
    ...
    public void createXqueryDuplicationReport() throws XQException, IOException {
        ...
        File xqueryFile = new File("api_and_internal.xqy");
