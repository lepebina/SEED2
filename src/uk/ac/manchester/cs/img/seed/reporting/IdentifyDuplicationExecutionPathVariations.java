...
public class IdentifyDuplicationExecutionPathVariations {
	public static void main(String[] args) throws XQException, IOException {
        new IdentifyDuplicationExecutionPathVariations().createXqueryDuplicationReport();
    }
    ...
    public void createXqueryDuplicationReport() throws XQException, IOException {
        ...
        File xqueryFile = new File("compare_essential_statements_trace.xqy");
