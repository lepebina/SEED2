...
public class IdentifyDuplicationAlgorithmThirteen {
    public static void main(String[] args) throws XQException, IOException {
        new IdentifyDuplicationAlgorithmThirteen().createXqueryDuplicationReport();
    }

    public void createXqueryDuplicationReport() throws XQException, IOException {        
      
        File xqueryFile = new File("trace_twelve.xqy");
