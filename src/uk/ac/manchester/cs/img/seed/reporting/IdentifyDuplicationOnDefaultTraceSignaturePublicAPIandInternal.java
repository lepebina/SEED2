...
public class IdentifyDuplicationOnDefaultTraceSignaturePublicAPIandInternal {
	public static void main(String[] args) throws XQException, IOException {
        new IdentifyDuplicationOnDefaultTraceSignaturePublicAPIandInternal().createXqueryDuplicationReport();
    }
    ...
    public void createXqueryDuplicationReport() throws XQException, IOException {
        ...
        File xqueryFile = new File("default_trace_signature_API_and_internal.xqy");
