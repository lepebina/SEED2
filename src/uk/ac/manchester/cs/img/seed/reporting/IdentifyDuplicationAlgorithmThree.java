...
public class IdentifyDuplicationAlgorithmThree {
    public static void main(String[] args) throws XQException, IOException {
        new IdentifyDuplicationAlgorithmThree().createXqueryDuplicationReport();
    }

    public void createXqueryDuplicationReport() throws XQException, IOException {       

        File xqueryFile = new File("trace_two.xqy");
