...
public class ConserveAbstractionLevel {
	private FileOutputStream fout;
	public static void main(String[] args) throws Exception {
		new ConserveAbstractionLevel().createDeleteSuggestionsReport();
	}
	...
	public void createDeleteSuggestionsReport() throws Exception {
		...
		File xqueryFile = new File("conserve_abstraction_levels.xqy");
