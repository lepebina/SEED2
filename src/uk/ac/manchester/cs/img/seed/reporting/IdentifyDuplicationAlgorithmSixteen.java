...
public class IdentifyDuplicationAlgorithmSixteen {
    public static void main(String[] args) throws XQException, IOException {
        new IdentifyDuplicationAlgorithmSixteen().createXqueryDuplicationReport();
    }

    public void createXqueryDuplicationReport() throws XQException, IOException {        
      
        File xqueryFile = new File("trace_fifteen.xqy");
