...
public class IdentifyDuplicationFullTraceVariations {
	public static void main(String[] args) throws XQException, IOException {
        new IdentifyDuplicationFullTraceVariations().createXqueryDuplicationReport();
    }
    ...
    public void createXqueryDuplicationReport() throws XQException, IOException {
        ...
        File xqueryFile = new File("compare_essential_full_trace.xqy");
