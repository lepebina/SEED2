...
public class IdentifyDuplicationAPIandInternalCallVariations {
	public static void main(String[] args) throws XQException, IOException {
        new IdentifyDuplicationAPIandInternalCallVariations().createXqueryDuplicationReport();
    }
    ...
    public void createXqueryDuplicationReport() throws XQException, IOException {
        ...
        File xqueryFile = new File("api_and_internal_call_variations.xqy");
