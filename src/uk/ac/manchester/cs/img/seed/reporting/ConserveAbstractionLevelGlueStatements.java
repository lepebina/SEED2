...
public class ConserveAbstractionLevelGlueStatements {
	private FileOutputStream fout;
	public static void main(String[] args) throws Exception {
		new ConserveAbstractionLevelGlueStatements().createDeleteSuggestionsReport();
	}
	...
	public void createDeleteSuggestionsReport() throws Exception {
		...
		File xqueryFile = new File("conserve_abstraction_levels_gluestmt.xqy");
