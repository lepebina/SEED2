...
public class IdentifyDuplicationOnDefaultTraceSignaturePublicAPI {
	public static void main(String[] args) throws XQException, IOException {
        new IdentifyDuplicationOnDefaultTraceSignaturePublicAPI().createXqueryDuplicationReport();
    }
    ...
    public void createXqueryDuplicationReport() throws XQException, IOException {
        ...
        File xqueryFile = new File("default_trace_signature_public_API.xqy");
