...
public class IdentifyDuplicationOnEssentialTraceSignatureandStatements {
	public static void main(String[] args) throws XQException, IOException {
        new IdentifyDuplicationOnEssentialTraceSignatureandStatements().createXqueryDuplicationReport();
    }
    ...
    public void createXqueryDuplicationReport() throws XQException, IOException {
        ...
        File xqueryFile = new File("essential_trace_signature_and_stmts.xqy");
