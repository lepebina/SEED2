...
public class IdentifyDuplicationOnDefaultTraceSignatureandStatements {
	public static void main(String[] args) throws XQException, IOException {
        new IdentifyDuplicationOnDefaultTraceSignatureandStatements().createXqueryDuplicationReport();
    }
    ...
    public void createXqueryDuplicationReport() throws XQException, IOException {
        ...
        File xqueryFile = new File("default_trace_signature_and_stmts.xqy");
