...
public class ConserveStepsDeleteSuggestions {
	private FileOutputStream fout;
	public static void main(String[] args) throws Exception {
		new ConserveStepsDeleteSuggestions().createDeleteSuggestionsReport();
	}
	...
	public void createDeleteSuggestionsReport() throws Exception {
		...
		File xqueryFile = new File("conserve_steps.xqy");
