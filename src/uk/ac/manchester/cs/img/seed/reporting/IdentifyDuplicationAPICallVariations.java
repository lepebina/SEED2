...
public class IdentifyDuplicationAPICallVariations {
	public static void main(String[] args) throws XQException, IOException {
        new IdentifyDuplicationAPICallVariations().createXqueryDuplicationReport();
    }
    ...
    public void createXqueryDuplicationReport() throws XQException, IOException {
        ...
        File xqueryFile = new File("api_call_variations.xqy");
